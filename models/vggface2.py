# Code from here: https://www.robots.ox.ac.uk/~albanie/pytorch-models.html
...
class SeNet50ScratchDAG(nn.Module):
...
def resnet50_scratch_dag(weights_path=None):
    """
...
def senet50_scratch_dag(weights_path=None):
    """
    load imported model instance
